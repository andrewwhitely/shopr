		...
		<div className='relative' ref={menuRef}>
			...
			{createPortal(
				<>
					{/* Backdrop */}
					<div
						className={`mobile-nav-backdrop fixed inset-0 bg-espresso/40 z-[100] sm:hidden ${isOpen ? 'open' : ''
							}`}
					...
					<div
						ref={panelRef}
						className={`mobile-menu-panel fixed top-0 right-0 h-full w-72 max-w-[85vw] bg-white shadow-2xl z-[110] sm:hidden pt-[env(safe-area-inset-top)] ${isOpen ? 'open' : ''
										...
										<div className='flex-1 min-w-0'>
													...
													<label className='block'>
														...
														<div className='flex rounded-lg border border-[#e3d9cf] bg-white overflow-hidden transition-all duration-200 hover:border-[#cfc0b2] focus-within:border-[var(--brand-primary)] focus-within:ring-[3px] focus-within:ring-[rgba(172,89,11,0.1)]'>
															...
															<input
																...
																className='flex-1 min-w-0 pl-1 pr-3 py-2.5 text-xs font-body border-0 focus:outline-none focus:ring-0'
											...
											{!isEditing && user.email && (
												<div className='flex items-center gap-1.5 mt-1'>
													...
													<span className='font-body text-xs text-warm-stone-500'>
														{user.email}
													</span>
												</div>
											)}
